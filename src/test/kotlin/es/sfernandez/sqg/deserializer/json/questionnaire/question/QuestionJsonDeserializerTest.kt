...
class QuestionJsonDeserializerTest {
    ...
    @Test
    fun deserialize_objectWithNoAnswer_returnQuestionWithUnspecifiedAnswerTest() {
        val json = JsonFixtures.EMPTY_JSON_OBJECT
        deserializer = createNormalDeserializer()

        val question = deserializer.deserialize(json)

        assertThat(question.answer).isInstanceOf(Answer::class.java)
        assertThat(question.answer.correction).isInstanceOf(UnspecifiedAnswerCorrection::class.java)
        assertThat(question.answer.input).isInstanceOf(UnspecifiedAnswerInput::class.java)
    }
    ...
    @Test
    fun deserialize_objectWithNoValidTypeAnswer_returnQuestionWithUnspecifiedAnswerTest() {
        val json = """
            {
                "${JsonKeys.Question.ANSWER}": []
            }
